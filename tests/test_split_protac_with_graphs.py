...
def test_split_protac_with_graphs(smiles, label):
    ...
    # Compare ignoring order of fragments (since assignment may differ)
    # Check that each label part is in the output (as substring, since atom ordering may differ)
