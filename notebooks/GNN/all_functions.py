...
#def get_node_labels(protac_smiles, substructure_smiles):           #Returns list
...
def process_boundaries_to_substructure_labels_v2_single(protac_smiles, raw_boundary_prediction):
    """
